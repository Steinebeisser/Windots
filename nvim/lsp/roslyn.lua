...
return {
    ...
    settings = {
        ...
        ["csharp|inlay_hints"] = {
            ...
            csharp_enable_inlay_hints_for_object_creation = true,
            csharp_enable_inlay_hints_for_other_variable_types = true,
            csharp_enable_inlay_hints_for_parameters = true,
            csharp_enable_inlay_hints_for_range_operators = true,
            csharp_enable_inlay_hints_for_ref_readonly_parameters = true,
            csharp_enable_inlay_hints_for_switch_expressions_and_parentheses = true,
            csharp_enable_inlay_hints_for_type_parameter_names = true,
            csharp_enable_inlay_hints_for_unresolved_api_usages = true,
            csharp_inlay_hints_options = "all_parameters",
